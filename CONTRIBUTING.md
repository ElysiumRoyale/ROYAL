Contributing to Elysium_Royale Core
============================

The Elysium_Royale Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/elysium_royale-project/elysium_royale/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Elysium_Royale Core project, and is not to be
confused with overall Elysium_Royale Network Protocol consensus changes.

Whether a pull request is merged into Elysium_Royale Core rests with the project merge
...
Patches that change Elysium_Royale consensus rules are considerably more involved than
...
Where a patchset proposes to change the Elysium_Royale consensus, it must have been
...
The project leader is the release manager for each Elysium_Royale Core release.
