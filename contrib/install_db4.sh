...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the elysium_royale repository."
  exit 1
fi
...
echo 'When compiling elysium_royaled, run `./configure` in the following way:'
echo
