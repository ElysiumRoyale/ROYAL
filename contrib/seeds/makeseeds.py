...
def main():
    ...
    # Filter out hosts with multiple elysium_royale ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple elysium_royale ports' % (ip_stats(ips)), file=sys.stderr)
