...
Failed to fetch the Elysium_Royale zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Elysium_Royale - fetch-params.sh

This script will fetch the Elysium_Royale zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Elysium_Royale zkSNARK parameters. Note that it is
