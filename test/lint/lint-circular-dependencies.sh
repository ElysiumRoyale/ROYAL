...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/elysium_royale/elysium_royalegui -> qt/elysium_royale/qtutils -> qt/elysium_royale/elysium_royalegui"
    "qt/elysium_royale/qtutils -> qt/elysium_royale/snackbar -> qt/elysium_royale/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zroyal/zroyalmodule -> validation"
