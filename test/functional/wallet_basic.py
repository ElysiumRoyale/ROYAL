...
class WalletTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ROYAL from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 ROYAL
        # - 7 coins of 250.00 ROYAL
        # - 1 coin of 228.9999xxxx ROYAL
