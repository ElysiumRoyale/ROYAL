...
By default, elysium_royaled will dump mempool on shutdown and
...
class MempoolPersistTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent elysium_royaled from writing mempool.dat to disk. Verify that `savemempool` fails")
