...
from test_framework.test_framework import Elysium_RoyaleTier2TestFramework
...
class MasternodeGovernanceBasicTest(Elysium_RoyaleTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.elysium_royale.org/t/test-proposal",
            2,
