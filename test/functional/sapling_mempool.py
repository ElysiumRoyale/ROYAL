#!/usr/bin/env python3
# Copyright (c) 2020 The Elysium_Royale Core developers
...
class SaplingMempoolTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 ROYAL note to Alice
        ...
        # miner sends another 10 ROYAL note to Alice
