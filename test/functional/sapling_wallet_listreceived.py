...
class ListReceivedTest (Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ROYAL.
        ...
        # Send 1 ROYAL to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ROYAL sending them all (fee is 0.1 ROYAL)
        ...
        # Confirm transaction (2 ROYAL from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ROYAL, send 0.6 ROYAL + 0.05 ROYAL fee
