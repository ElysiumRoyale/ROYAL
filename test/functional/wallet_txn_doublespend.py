...
class TxnMallTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 ROYAL:
        ...
        # First: use raw transaction API to send 1240 * 5 ROYAL to node1_address,
        # but don't broadcast:
