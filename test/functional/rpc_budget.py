...
class BudgetProposalTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Elysium_Royale address")
        assert_raises_rpc_error(-5, "Invalid Elysium_Royale address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 ROYAL allowed" % invalid_amt, self.nodes[0].preparebudget,
