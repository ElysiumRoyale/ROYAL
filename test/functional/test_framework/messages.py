...
COIN = 100000000 # 1 ROYAL in satoshis
...
# Objects that map to elysium_royaled objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in elysium_royaled indicates these should be deserialized as blocks
