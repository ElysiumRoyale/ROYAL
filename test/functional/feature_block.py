...
class FullBlockTest(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure elysium_royaled isn't accepting b26
        ...
        # Extend the b28 chain to make sure elysium_royaled isn't accepting b28
        ...
        # Elysium_Royale: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the elysium_royale code has custom code which does so);
