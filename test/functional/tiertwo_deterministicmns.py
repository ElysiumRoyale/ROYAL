...
class DIP3Test(Elysium_RoyaleTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 ROYAL) to the operator, and (2 * 2.7 ROYAL) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid Elysium_Royale address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid Elysium_Royale address InvalidPayee", controller.protx_update_registrar,
