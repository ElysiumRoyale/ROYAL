...
class NetTest(Elysium_RoyaleTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 6150)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 6150)
