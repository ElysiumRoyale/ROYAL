...
// Copyright (c) 2022 The Elysium_Royale Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://www.opensource.org/licenses/mit-license.php.

#ifndef Elysium_Royale_NETFULFILLEDMAN_H
#define Elysium_Royale_NETFULFILLEDMAN_H
...
#endif // Elysium_Royale_NETFULFILLEDMAN_H
