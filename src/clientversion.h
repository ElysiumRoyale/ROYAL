...
#error Client version information missing: version is not defined by elysium_royale-config.h or in any other way
#endif
...
/**
 * elysium_royaled-res.rc includes this file, but it cannot cope with real c++ code.
