...
#ifndef Elysium_Royale_SUPPORT_ALLOCATORS_POOLED_SECURE_H
#define Elysium_Royale_SUPPORT_ALLOCATORS_POOLED_SECURE_H
...
#endif // Elysium_Royale_SUPPORT_ALLOCATORS_POOLED_SECURE_H
