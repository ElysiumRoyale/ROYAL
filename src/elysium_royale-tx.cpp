...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " elysium_royale-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  elysium_royale-tx [options] <hex-tx> [commands]  Update hex-encoded elysium_royale transaction\n" +
                               "or:     elysium_royale-tx [options] -create [commands]   Create hex-encoded elysium_royale transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded elysium_royale transaction
