...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            Elysium_RoyaleGUI* window = static_cast<Elysium_RoyaleGUI*>(parentWidget());
...
{
    Elysium_RoyaleGUI* gui = static_cast<Elysium_RoyaleGUI*>(parentWidget());
...
{
    hide();
    static_cast<Elysium_RoyaleGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ROYALs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
