...
#ifndef Elysium_Royale_QT_WALLETMODEL_H
#define Elysium_Royale_QT_WALLETMODEL_H
...
/** Interface to Elysium_Royale wallet from Qt view code. */
...
#endif // Elysium_Royale_QT_WALLETMODEL_H
