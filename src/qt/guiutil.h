...
/** Utility functions used by the Elysium_Royale Qt UI.
 */
namespace GUIUtil
{
...
// Render Elysium_Royale addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZroyal = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZroyal = false);
...
// Parse "elysium_royale:" URI into recipient object, return true on successful parsing
