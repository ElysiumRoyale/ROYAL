...
#include "qt/elysium_royale/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(Elysium_RoyaleGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &Elysium_RoyaleGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
