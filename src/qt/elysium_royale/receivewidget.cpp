...
#include "qt/elysium_royale/forms/ui_receivewidget.h"
...
#include "qt/elysium_royale/myaddressrow.h"
...
ReceiveWidget::ReceiveWidget(Elysium_RoyaleGUI* parent) :
    PWidget(parent),
