...
#ifndef Elysium_Royale_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Elysium_Royale_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Elysium_Royale_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
