...
#include "qt/elysium_royale/forms/ui_votedialog.h"

#include "qt/elysium_royale/mnmodel.h"
#include "qt/elysium_royale/mnselectiondialog.h"
...
{
    Elysium_RoyaleGUI* window = dynamic_cast<Elysium_RoyaleGUI*>(parent());
