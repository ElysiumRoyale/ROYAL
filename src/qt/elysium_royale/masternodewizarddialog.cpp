...
#include "qt/elysium_royale/forms/ui_masternodewizarddialog.h"
    ...
    mnModel(_mnModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a Elysium_Royale Masternode you must dedicate %1 (the unit of Elysium_Royale) "
