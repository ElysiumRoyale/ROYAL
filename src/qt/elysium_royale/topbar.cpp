...
#include "qt/elysium_royale/topbar.h"
#include "qt/elysium_royale/forms/ui_topbar.h"
#include "qt/elysium_royale/lockunlock.h"
#include "qt/elysium_royale/qtutils.h"
#include "qt/elysium_royale/receivedialog.h"
#include "qt/elysium_royale/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/elysium_royale/balancebubble.h"
...
TopBar::TopBar(Elysium_RoyaleGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountRoyal}, "amount-topbar");
    setCssProperty({ui->labelPendingRoyal, ui->labelImmatureRoyal, ui->labelAvailableRoyal, ui->labelLockedRoyal, ui->labelStakingStatus,
                       ui->labelCollateralRoyal, ui->labelMNRewardvalue, ui->labelStakingRewardvalue},"amount-small-topbar");
    ...
    ui->pushButtonConf->setButtonText("elysiumroyale.conf");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Elysium_Royale")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // ROYAL Total
    QString totalRoyal = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // Expanded
    ui->labelAmountRoyal->setText(GUIUtil::formatBalance(newBalance.balance + newBalance.immature_balance, nDisplayUnit));
    ui->labelAvailableRoyal->setText(GUIUtil::formatBalance(nAvailableBalance, nDisplayUnit));
