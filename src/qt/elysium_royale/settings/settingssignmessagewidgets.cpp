...
#include "qt/elysium_royale/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(Elysium_RoyaleGUI* _window, QWidget *parent) :
