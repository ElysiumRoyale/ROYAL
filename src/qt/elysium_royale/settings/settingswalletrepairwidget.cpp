...
#include "qt/elysium_royale/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/elysium_royale/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(Elysium_RoyaleGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to Elysium_RoyaleGUI::handleRestart()
