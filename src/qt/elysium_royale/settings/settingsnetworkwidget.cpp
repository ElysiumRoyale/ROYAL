...
#include "qt/elysium_royale/settings/settingsnetworkwidget.h"
#include "qt/elysium_royale/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/elysium_royale/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(Elysium_RoyaleGUI* _window, QWidget *parent) :
