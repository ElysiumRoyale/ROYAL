...
#include "qt/elysium_royale/settings/settingsbackupwallet.h"
#include "qt/elysium_royale/settings/settingsexportcsv.h"
#include "qt/elysium_royale/settings/settingsbittoolwidget.h"
#include "qt/elysium_royale/settings/settingssignmessagewidgets.h"
#include "qt/elysium_royale/settings/settingswalletrepairwidget.h"
#include "qt/elysium_royale/settings/settingswalletoptionswidget.h"
#include "qt/elysium_royale/settings/settingsmainoptionswidget.h"
#include "qt/elysium_royale/settings/settingsdisplayoptionswidget.h"
#include "qt/elysium_royale/settings/settingsinformationwidget.h"
#include "qt/elysium_royale/settings/settingsconsolewidget.h"

class Elysium_RoyaleGUI;
...
public:
    explicit SettingsWidget(Elysium_RoyaleGUI* parent);
    ~SettingsWidget();
