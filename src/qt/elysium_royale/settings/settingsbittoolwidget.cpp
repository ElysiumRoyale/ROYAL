...
#include "qt/elysium_royale/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(Elysium_RoyaleGUI* _window, QWidget *parent) :
