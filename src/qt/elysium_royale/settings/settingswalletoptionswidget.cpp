...
#include "qt/elysium_royale/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/elysium_royale/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(Elysium_RoyaleGUI* _window, QWidget *parent) :
