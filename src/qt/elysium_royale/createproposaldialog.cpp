...
#include "qt/elysium_royale/createproposaldialog.h"
#include "qt/elysium_royale/forms/ui_createproposaldialog.h"

#include "qt/elysium_royale/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(Elysium_RoyaleGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.elysium_royale/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 ROYAL");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<Elysium_RoyaleGUI*>(parent()),
                this
        );
