...
#include "qt/elysium_royale/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, Elysium_RoyaleGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
