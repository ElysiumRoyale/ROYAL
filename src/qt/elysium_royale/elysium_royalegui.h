...
#ifndef Elysium_Royale_CORE_NEW_GUI_Elysium_RoyaleGUI_H
#define Elysium_Royale_CORE_NEW_GUI_Elysium_RoyaleGUI_H
...
#include "qt/elysium_royale/navmenuwidget.h"
#include "qt/elysium_royale/topbar.h"
#include "qt/elysium_royale/dashboardwidget.h"
#include "qt/elysium_royale/send.h"
#include "qt/elysium_royale/receivewidget.h"
#include "qt/elysium_royale/addresseswidget.h"
#include "qt/elysium_royale/coldstakingwidget.h"
#include "qt/elysium_royale/governancewidget.h"
#include "qt/elysium_royale/masternodeswidget.h"
#include "qt/elysium_royale/snackbar.h"
#include "qt/elysium_royale/settings/settingswidget.h"
...
/**
  Elysium_Royale GUI main class. This class represents the main window of the Elysium_Royale UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Elysium_RoyaleGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Elysium_RoyaleGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~Elysium_RoyaleGUI();
...
#endif //Elysium_Royale_CORE_NEW_GUI_Elysium_RoyaleGUI_H
