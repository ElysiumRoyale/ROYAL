...
#include <QWidget>
#include <QString>
#include "qt/elysium_royale/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(Elysium_RoyaleGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    Elysium_RoyaleGUI* getWindow() { return this->window; }
