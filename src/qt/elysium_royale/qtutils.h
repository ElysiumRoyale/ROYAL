...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, Elysium_RoyaleGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, Elysium_RoyaleGUI* gui, double posX = 3);
