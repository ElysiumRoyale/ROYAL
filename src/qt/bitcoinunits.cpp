...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ROYAL);
    unitlist.append(mROYAL);
    unitlist.append(uROYAL);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ROYAL:
        return QString("elysium royale");
    case mROYAL:
        return QString("melysium royale");
    case uROYAL:
        return QString::fromUtf8("uelysium royale");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZroyal)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZROYAL)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZROYAL)
{
