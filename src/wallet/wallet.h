...
#ifndef Elysium_Royale_WALLET_H
#define Elysium_Royale_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_Elysium_Royale = 61000, // inherited version..
...
public:
     ...
     * Elysium_Royale: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 ROYAL output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CRoyalStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
