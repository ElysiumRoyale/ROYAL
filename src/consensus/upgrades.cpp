...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        {
                /*.strName =*/ "Base",
                /*.strInfo =*/ "Elysium_Royale network",
        },
        {
                /*.strName =*/ "PoS",
        ...
        {
                /*.strName =*/ "Elysium_Royale_v3.4",
                /*.strInfo =*/ "New 256-bit stake modifier - start block v6",
        },
        {
                /*.strName =*/ "Elysium_Royale_v4.0",
        ...
        {
                /*.strName =*/ "Elysium_Royale_v5.2",
                /*.strInfo =*/ "New cold-staking rules",
        },
        {
                /*.strName =*/ "Elysium_Royale_v5.3",
                /*.strInfo =*/ "New staking rules",
        },
        {
                /*.strName =*/ "Elysium_Royale_v5.5",
