...
public:
    ...
    /**
     * Amount of elysium_royale coming in to a transaction
...
// Elysium_Royale: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
