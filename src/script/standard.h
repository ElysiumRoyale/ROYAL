 ...
 *  A CTxDestination is the internal data type encoded in a Elysium_Royale address
 */
...
/**
 * Generate a Elysium_Royale scriptPubKey for the given CTxDestination. Returns a P2PKH
