...
#define BOOST_TEST_MODULE Elysium_Royale Test Suite
...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName)
    : m_path_root{fs::temp_directory_path() / "test_elysium_royale" / std::to_string(g_insecure_rand_ctx_temp_path.rand32())}
{
    ECC_Start();
    BLSInit();
    SetupEnvironment();
