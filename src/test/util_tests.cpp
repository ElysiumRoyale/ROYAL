...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("elysium_royale"), "Elysium_Royale");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://elysium_royale.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/elysium_royale"));
    BOOST_CHECK(validateURL("https://foo.bar/elysium_royale/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.elysium_royale.com"));
