...
extern const char * const Elysium_Royale_CONF_FILENAME;
extern const char * const Elysium_Royale_PID_FILENAME;
extern const char * const Elysium_Royale_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = "elysium_royale-" + name;
