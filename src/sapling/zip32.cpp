...
const unsigned char Elysium_Royale_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'P', 'I', 'V', 'X', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char Elysium_Royale_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
...
{
    CBLAKE2bWriter h(SER_GETHASH, 0, Elysium_Royale_HD_SEED_FP_PERSONAL);
    h << seed;
    return h.GetHash();
}
...
uint256 ovkForShieldingFromTaddr(HDSeed& seed) {
    ...
    assert(crypto_generichash_blake2b_init_salt_personal(
            ...
            64,
            NULL,    // No salt.
            Elysium_Royale_TADDR_OVK_PERSONAL) == 0);
