...
This document provides guidelines for internationalization of the Elysium_Royale Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Elysium_Royale network</source>
        <translation>
            <numerusform>%n active connection to Elysium_Royale network</numerusform>
            <numerusform>%n active connections to Elysium_Royale network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `elysium_royale_en.ts` remains unchanged.
