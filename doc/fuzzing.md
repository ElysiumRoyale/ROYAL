Fuzz-testing Elysium_Royale Core
==========================
...
To build Elysium_Royale Core using AFL instrumentation (this assumes that the
...
with certain assembly code from Elysium_Royale Core's code. See [developer notes on sanitizers](https://github.com/Elysium_Royale-Project/Elysium_Royale/blob/master/doc/developer-notes.md#sanitizers)
