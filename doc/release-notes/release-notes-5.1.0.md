Elysium_Royale Core version v5.1.0 is now available from:  <https://github.com/elysium_royale-project/elysium_royale/releases>
...
- #2170 Better elysium_royale.conf Masternode data error notification (furszy)
