...
The build script we'll be using is contained in the Elysium_Royale github repository ([contrib/gitian-build.py](https://github.com/elysium_royale-project/elysium_royale/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Elysium_Royale repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Elysium_Royale-Project/Elysium_Royale/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, elysium_royale-detached-sigs, and elysium_royale GitHub repos.
